...
class CardDetailsAccount extends StatefulWidget {
  CardDetailsAccount({
    Key key,
    @required this.barTitle,
  }) : assert(barTitle != null), super(key: key);

  final String barTitle;

  @override
  CardDetailsAccountState createState() {
    return CardDetailsAccountState();
  }
}

class CardDetailsAccountState extends State<CardDetailsAccount> {
  // Declarations.
  // Create a global key that will uniquely identify the Form widget and allow
  // us to validate the form.
  // Note: This is a `GlobalKey<FormState>`, not a GlobalKey<MyCustomFormState>!
  final _cardDetailsAccountFormKey = GlobalKey<FormState>();
  bool _autoValidate;
      ...
      child: new ListView(
        ...
        children: <Widget>[
          ...
          new Padding(
            ...
            child: new Form(
              key: _cardDetailsAccountFormKey,
            ...
            child: new SizedBox(
              ...
              child: new FlatButton(
                ...
                onPressed: () {
                  ...
                  final form = _cardDetailsAccountFormKey.currentState;
                  if(form.validate()){
                    print('Save user!');
                    if(_saveDefaultCard) {
                      print('Persist card!');
          ...
          new DecoratedBox(
            ...
            child: new SizedBox(
              ...
              child: new FlatButton(
                ...
                child: new Text(
                  Translations.of(context).text('delete_card'),
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.subhead.copyWith(
                    color: Colors.red,
                  ),
